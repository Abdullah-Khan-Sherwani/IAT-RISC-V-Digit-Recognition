...
executeV:
	-whisper -x $(TEMPPATH)/programV.hex -s 0x80000000 --tohost 0xd0580000 --configfile ./veer/whisper.json
...
executeNV:
	-whisper -x $(TEMPPATH)/programNV.hex -s 0x80000000 --tohost 0xd0580000 --configfile ./veer/whisper.json
