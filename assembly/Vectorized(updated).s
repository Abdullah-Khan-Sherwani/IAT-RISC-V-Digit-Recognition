...
# ###############################TEST############################
    ...
    # Vectorized dense call
    call vectorized_dense
...
################################################################################
# Vectorized Flatten (RV32V)
################################################################################
.vectorized_flatten:
    # a0 = &output_max_flattened, t1 = &output_max
    li t3, 144
    li t4, 576
    li t5, 8
    li t0, 8
...
flatten_loop:
    ...
    vse32.v v0, (t7)
    addi t2, t2, 1
    blt  t2, t3, flatten_loop
    ret

################################################################################
# Vectorized Dense (RV32V)
################################################################################
.vectorized_dense:
    # a0=W, a1=x, a2=b, a3=Z, t1=N=1152, t2=M=10
    li t0, 0
    vsetvli t3, zero, e32, m1
